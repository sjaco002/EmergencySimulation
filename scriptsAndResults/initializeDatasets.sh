...
create index time1 on EmergencyReports(timeStamp);
create index time2 on UserLocations(timeStamp);
create index loc1 on EmergencyReports(location) type rtree;
create index loc2 on UserLocations(location) type rtree;
